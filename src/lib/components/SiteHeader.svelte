...
<a
href="/"
class="flex items-center gap-3 text-xl font-black uppercase tracking-tight transition-colors hover:text-amber-500"
>
<div
...
<button
type="submit"
class="inline-flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-semibold uppercase tracking-wide transition-colors hover:bg-stone-100 dark:hover:bg-stone-700"
...
<!-- Mobile navigation -->
<nav
class="flex items-center gap-1 overflow-x-auto border-t-2 border-amber-200 bg-amber-50 px-4 py-2 dark:border-stone-700 dark:bg-stone-900 md:hidden"
...
<a
href={category.href}
class="inline-flex items-center gap-1.5 whitespace-nowrap rounded px-3 py-1.5 text-sm font-semibold uppercase transition-colors {pathname.startsWith(
category.href
)
