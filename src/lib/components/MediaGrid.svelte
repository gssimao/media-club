...
<p class="text-sm font-bold uppercase tracking-wide text-stone-600 dark:text-stone-400">
...
>
<h2 class="text-lg font-black uppercase text-stone-900 dark:text-white">{emptyTitle}</h2>
